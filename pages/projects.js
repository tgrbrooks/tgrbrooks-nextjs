  ...
  return (
    <PageLayout title="Projects" type={3}>
      ...
      <section className={utilStyles.headingMd}>
        <p>I usually have a few side projects on the go at varying levels of completion, most of which can be found on my <DarkLink link="https://github.com/tgrbrooks" name="GitHub page" />.</p>
      ...
      <CardDeck>
        <ProjectCard title={"ADA: Algal Data Analyser"} image={"ada2.png"} repo={"ADA"} status={"Maintained"}>
          ...
          <DarkButton link="https://algaeplotter.readthedocs.io/en/latest/" name="Documentation" />
        </ProjectCard>
